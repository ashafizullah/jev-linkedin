...
every job scored so far: sortable by match, recency or company, filterable by verdict,
searchable by title or company, and linked back to each posting. It shows the running batch,
lets you stop it, and refreshes itself while a batch is in progress.
